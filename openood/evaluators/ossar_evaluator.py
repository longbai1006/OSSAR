...
class OSSAREvaluator(OODEvaluator):
    ...
    def eval_acc(self,
        ...
        criterion = net['criterion'] # ARPLayer
        net = net['netF']
        net.eval()
        ...
        with torch.no_grad():
            for batch in tqdm(data_loader,
                ...
                _labels.append(target.data.cpu().numpy())
        ...
        if not fsood:
            ...
            metrics['OSCR'] =  _oscr_socre * 100
            metrics['AUROC'] = results['AUROC']
            return metrics
        else:
            all_correct = 0
            all_total = 0
