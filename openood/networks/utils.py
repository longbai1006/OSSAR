...
def get_network(network_config):
    ...
    if network_config.name == 'resnet18_32x32':
        ...
        from .ossar_net import (resnet34ABN, Generator, Discriminator,
                               Generator32, Discriminator32, OSSARLayer)
        ...
        criterion = OSSARLayer(feat_dim=dim_centers,
                             num_classes=num_classes,
    ...
    elif network_config.name == 'ossar_net':
        from .ossar_net import OSSARLayer
