...
class TrainARPLGANPipeline:
    ...
    def run(self):
        ...
        trainer_aux = get_trainer(net, train_loader, val_loader, self.config)
        ...
        for epoch_idx in range(1, self.config.optimizer.num_epochs + 1):
            ...
            val_metrics = evaluator.eval_acc(net, val_loader, out_loader, None,
                                                 epoch_idx)
        ...
        test_metrics = evaluator.eval_acc(net, test_loader, out_loader)
